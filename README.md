...
<h2 align="center">Мобильное приложение для разделения оплаты</h2>
...
Сумма оплаты за покупку может быть разделена между людьми из списка контактов. После подтверждение покупки пользователем приложение автоматически выставит счета, пересчитает сумму долга между всеми пользователями и направит уведомления о новом счете.
